...
interface CmnModalProps extends Omit<ModalProps, 'size'> {
  children: ReactNode;
  isOpen?: boolean;
...
function CmnModal(props: CmnModalProps) {
  const {
    children,
    isOpen = false,
    classNameWrap,
    ...
    <>
      ...
      <div className={classNameWrap}>
        <Modal
          ...
          placement={placement}
          className={cn('bg-white rounded-lg shadow-lg no-scrollbar', className)}
