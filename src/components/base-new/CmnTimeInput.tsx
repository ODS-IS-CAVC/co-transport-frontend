...
function CmnTimeInput(props: CmnTimeInputProps) {
  ...
  const handleBlur = () => {
    if ((!timeStart && timeEnd) || (!timeEnd && timeStart) || (timeEnd && timeStart && timeEnd < timeStart)) {
      onError(getMessage());
  ...
  return (
    <div className={classNameWrap}>
      ...
      <div
        className={cn(
          'flex items-center justify-between border border-[#D9D9D9] rounded-lg',
